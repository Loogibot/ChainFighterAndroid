...
class MoveResult {
    companion object Results {
        ...
        val neutral = ChainResult(neutral_result, "NEUTRAL", "NEUTRAL")
        val cancel =
            ChainResult(cancel_image, "MOVES CANCEL EACH OTHER!", "ALL MOVES CANCEL EACH OTHER!")
        val playerWin =
            ChainResult(player_move_win, "PLAYER MOVE IS EFFECTIVE!", "PLAYER CHAIN IS EFFECTIVE!")
        val opponentWin = ChainResult(
            opponent_move_win,
